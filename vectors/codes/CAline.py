import sys
sys.path.insert(0,'/sdcard/geometry/geometry/codes/CoordGeo') #for path to external scripts
...
#if using termux
plt.savefig('/sdcard/geometry/geometry/figs/tri.jpg')
